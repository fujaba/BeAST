 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.WordPressImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link model.impl.WordPressImpl#getId <em>Id</em>}</li>
 *   <li>{@link model.impl.WordPressImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WordPressImpl extends MinimalEObjectImpl.Container implements WordPress
{
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.WORD_PRESS__NAME, oldName, name));
	}
	...
	public void setId(int newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.WORD_PRESS__ID, oldId, id));
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectResolvingEList<Service>(Service.class, this, ModelPackage.WORD_PRESS__SERVICES);
		}
		return services;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case ModelPackage.WORD_PRESS__ID:
				return getId();
			case ModelPackage.WORD_PRESS__SERVICES:
				return getServices();
		}
