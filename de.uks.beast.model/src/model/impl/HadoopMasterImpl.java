 ...
 *   <li>{@link model.impl.HadoopMasterImpl#getId <em>Id</em>}</li>
 *   <li>{@link model.impl.HadoopMasterImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HadoopMasterImpl extends MinimalEObjectImpl.Container implements HadoopMaster
{
	...
	public void setId(int newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.HADOOP_MASTER__ID, oldId, id));
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectResolvingEList<Service>(Service.class, this, ModelPackage.HADOOP_MASTER__SERVICES);
		}
		return services;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case ModelPackage.HADOOP_MASTER__ID:
				return getId();
			case ModelPackage.HADOOP_MASTER__SERVICES:
				return getServices();
		}
