 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.JenkinsImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link model.impl.JenkinsImpl#getId <em>Id</em>}</li>
 *   <li>{@link model.impl.JenkinsImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JenkinsImpl extends MinimalEObjectImpl.Container implements Jenkins
{
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.JENKINS__NAME, oldName, name));
	}
	...
	public void setId(int newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.JENKINS__ID, oldId, id));
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectResolvingEList<Service>(Service.class, this, ModelPackage.JENKINS__SERVICES);
		}
		return services;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case ModelPackage.JENKINS__ID:
				return getId();
			case ModelPackage.JENKINS__SERVICES:
				return getServices();
		}
