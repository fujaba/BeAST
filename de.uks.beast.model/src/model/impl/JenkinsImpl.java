 ...
 * <ul>
 *   <li>{@link model.impl.JenkinsImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link model.impl.JenkinsImpl#getRelations <em>Relations</em>}</li>
...
public class JenkinsImpl extends MinimalEObjectImpl.Container implements Jenkins
{
	...
	public void setTitle(String newTitle)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.JENKINS__TITLE, oldTitle, title));
	}
	...
	public EList<Service> getRelations()
	{
		if (relations == null)
		{
			relations = new EObjectResolvingEList<Service>(Service.class, this, ModelPackage.JENKINS__RELATIONS);
		}
		return relations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ModelPackage.JENKINS__TITLE:
				return getTitle();
			case ModelPackage.JENKINS__RELATIONS:
				return getRelations();
