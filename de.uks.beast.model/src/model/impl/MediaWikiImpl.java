 ...
 *   <li>{@link model.impl.MediaWikiImpl#getId <em>Id</em>}</li>
 *   <li>{@link model.impl.MediaWikiImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MediaWikiImpl extends MinimalEObjectImpl.Container implements MediaWiki
{
	...
	public void setId(int newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MEDIA_WIKI__ID, oldId, id));
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectResolvingEList<Service>(Service.class, this, ModelPackage.MEDIA_WIKI__SERVICES);
		}
		return services;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case ModelPackage.MEDIA_WIKI__ID:
				return getId();
			case ModelPackage.MEDIA_WIKI__SERVICES:
				return getServices();
		}
