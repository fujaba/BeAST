 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.CassandraImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link model.impl.CassandraImpl#getId <em>Id</em>}</li>
 *   <li>{@link model.impl.CassandraImpl#getServices <em>Services</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CassandraImpl extends MinimalEObjectImpl.Container implements Cassandra
{
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CASSANDRA__NAME, oldName, name));
	}
	...
	public void setId(int newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CASSANDRA__ID, oldId, id));
	}
	...
	public EList<Service> getServices() {
		if (services == null) {
			services = new EObjectResolvingEList<Service>(Service.class, this, ModelPackage.CASSANDRA__SERVICES);
		}
		return services;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID) {
			...
			case ModelPackage.CASSANDRA__ID:
				return getId();
			case ModelPackage.CASSANDRA__SERVICES:
				return getServices();
		}
