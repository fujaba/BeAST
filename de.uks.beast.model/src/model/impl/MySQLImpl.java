 ...
 * <ul>
 *   <li>{@link model.impl.MySQLImpl#getType <em>Type</em>}</li>
...
public class MySQLImpl extends MinimalEObjectImpl.Container implements MySQL
{
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MY_SQL__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ModelPackage.MY_SQL__TYPE:
				return getType();
