 ...
 * <ul>
 *   <li>{@link model.impl.MySQLImpl#getTitle <em>Title</em>}</li>
 ...
 * @generated
 */
public class MySQLImpl extends MinimalEObjectImpl.Container implements MySQL
{
	/**
	...
	{
		return ModelPackage.Literals.MY_SQL;
	}
	...
	public void setTitle(String newTitle)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MY_SQL__TITLE, oldTitle, title));
	}
	...
	public void setServiceName(String newServiceName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MY_SQL__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setServiceType(String newServiceType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MY_SQL__SERVICE_TYPE, oldServiceType, serviceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case ModelPackage.MY_SQL__TITLE:
				return getTitle();
