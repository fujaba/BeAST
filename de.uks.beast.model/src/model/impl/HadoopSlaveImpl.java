 ...
 * <ul>
 *   <li>{@link model.impl.HadoopSlaveImpl#getTitle <em>Title</em>}</li>
...
public class HadoopSlaveImpl extends MinimalEObjectImpl.Container implements HadoopSlave
{
	...
	public void setTitle(String newTitle)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.HADOOP_SLAVE__TITLE, oldTitle, title));
	}
