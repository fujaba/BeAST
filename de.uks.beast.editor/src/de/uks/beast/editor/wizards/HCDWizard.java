...
public class HCDWizard extends Wizard implements INewWizard
{
	...
	{
		final Diagram diagram = Graphiti.getPeCreateService().createDiagram(Messages.DIAGRAM_TYPEID.text(), file.getName(), true);
	...
	{
		final IStatus status = new Status(IStatus.ERROR, Messages.PLUGIN_ID.text(), IStatus.OK, message, null);
