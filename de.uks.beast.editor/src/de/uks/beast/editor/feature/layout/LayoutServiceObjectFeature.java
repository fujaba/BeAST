...
public class LayoutServiceObjectFeature extends AbstractLayoutFeature
{
	
	public LayoutServiceObjectFeature(final IFeatureProvider fp)
	{
		super(fp);
	}
	...
	public boolean layout(final ILayoutContext context)
	{
		...
		// height
		if (containerGa.getHeight() < SERVICE_INITIAL_HEIGHT)
		{
			containerGa.setHeight(SERVICE_INITIAL_HEIGHT);
