...
public class ColorConstants
{
	...
	//rack
	public static final IColorConstant	RACK_TEXT_FOREGROUND			= IColorConstant.BLACK;
	public static final IColorConstant	RACK_FOREGROUND					= new ColorConstant(98, 131, 167);
	public static final IColorConstant	RACK_BACKGROUND					= new ColorConstant(187, 218, 247);
	
	//room
	public static final IColorConstant	ROOM_TEXT_FOREGROUND			= IColorConstant.BLACK;
	public static final IColorConstant	ROOM_FOREGROUND					= new ColorConstant(98, 131, 167);
	public static final IColorConstant	ROOM_BACKGROUND					= new ColorConstant(187, 218, 247);
