package de.uks.beast.editor.service.services.ubuntu.add;
...
public class AddUbuntuFeature extends AbstractAddShapeFeature
{
	
	public AddUbuntuFeature(final IFeatureProvider fp)
	{
		super(fp);
	}
