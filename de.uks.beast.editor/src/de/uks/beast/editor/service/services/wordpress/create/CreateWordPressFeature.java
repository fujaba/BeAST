package de.uks.beast.editor.service.services.wordpress.create;
...
public class CreateWordPressFeature extends AbstractCreateFeature
{
	
	public CreateWordPressFeature(final IFeatureProvider fp, final String name, final String description)
	{
	...
	public Object[] create(final ICreateContext context)
	{
		...
		service.setTitle(Strings.WORDPRESS.text());
