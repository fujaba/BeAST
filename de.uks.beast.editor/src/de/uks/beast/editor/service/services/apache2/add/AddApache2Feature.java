package de.uks.beast.editor.service.services.apache2.add;
...
public class AddApache2Feature extends AbstractAddShapeFeature
{
	...
	public PictogramElement add(final IAddContext context)
	{
		...
		final Image objectIcon = gaService.createImage(containerShape, Images.APACHE2_OBJECT_IMAGE.getImageID());
