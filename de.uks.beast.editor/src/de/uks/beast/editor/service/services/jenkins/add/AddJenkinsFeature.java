package de.uks.beast.editor.service.services.jenkins.add;
...
public class AddJenkinsFeature extends AbstractAddShapeFeature
{
	
	public AddJenkinsFeature(final IFeatureProvider fp)
	{
		super(fp);
	}
	...
	public PictogramElement add(final IAddContext context)
	{
		...
		final Image objectIcon = gaService.createImage(containerShape, Images.JENKINS_OBJECT_IMAGE.getImageID());
