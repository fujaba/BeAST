package de.uks.beast.editor.service.services.mediawiki.add;
...
public class AddMediaWikiFeature extends AbstractAddShapeFeature
{
	
	public AddMediaWikiFeature(final IFeatureProvider fp)
	{
		super(fp);
	}
