package de.uks.beast.editor.service.services.wordpress.add;
...
public class AddWordPressFeature extends AbstractAddShapeFeature
{
	
	public AddWordPressFeature(final IFeatureProvider fp)
	{
		super(fp);
	}
	...
	public PictogramElement add(final IAddContext context)
	{
		...
		final Image objectIcon = gaService.createImage(containerShape, Images.WORDPRESS_OBJECT_IMAGE.getImageID());
