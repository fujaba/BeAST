...
/**
 * This is the item provider adapter for a {@link model.Ubuntu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UbuntuItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public UbuntuItemProvider(AdapterFactory adapterFactory)
	{
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Ubuntu"));
	}
	...
	{
		String label = ((Ubuntu)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_Ubuntu_type") :
			getString("_UI_Ubuntu_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(Ubuntu.class))
		{
