...
/**
 * This is the item provider adapter for a {@link model.Cassandra} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CassandraItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public CassandraItemProvider(AdapterFactory adapterFactory)
	{
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Cassandra"));
	}
	...
	{
		String label = ((Cassandra)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Cassandra_type") :
			getString("_UI_Cassandra_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(Cassandra.class))
		{
			case ModelPackage.CASSANDRA__NAME:
