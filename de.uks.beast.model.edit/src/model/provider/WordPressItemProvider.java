...
/**
 * This is the item provider adapter for a {@link model.WordPress} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WordPressItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public WordPressItemProvider(AdapterFactory adapterFactory)
	{
	...
	protected void addRelationsPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_relations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_relations_feature", "_UI_Service_type"),
				 ModelPackage.Literals.SERVICE__RELATIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.SERVICE__SERVICE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.SERVICE__SERVICE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WordPress"));
	}
	...
	{
		String label = ((WordPress)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WordPress_type") :
			getString("_UI_WordPress_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(WordPress.class))
		{
			case ModelPackage.WORD_PRESS__NAME:
