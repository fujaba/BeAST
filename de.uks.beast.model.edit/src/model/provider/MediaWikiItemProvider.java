...
/**
 * This is the item provider adapter for a {@link model.MediaWiki} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MediaWikiItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public MediaWikiItemProvider(AdapterFactory adapterFactory)
	{
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MediaWiki"));
	}
	...
	{
		String label = ((MediaWiki)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MediaWiki_type") :
			getString("_UI_MediaWiki_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(MediaWiki.class))
		{
