...
/**
 * This is the item provider adapter for a {@link model.MongoDB} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MongoDBItemProvider 
		...
		IItemPropertySource
{
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MongoDB"));
	}
	...
	{
		String label = ((MongoDB)object).getServiceName();
