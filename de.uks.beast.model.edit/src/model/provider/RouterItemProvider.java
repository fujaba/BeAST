...
/**
 * This is the item provider adapter for a {@link model.Router} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addExternalGatewayPropertyDescriptor(object);
		}
	...
	protected void addIdPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Router_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Router_id_feature", "_UI_Router_type"),
				 ModelPackage.Literals.ROUTER__ID,
				 true,
				 false,
				 false,
	...
	protected void addIpPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Router_ip_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Router_ip_feature", "_UI_Router_type"),
				 ModelPackage.Literals.ROUTER__IP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Router_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Router_name_feature", "_UI_Router_type"),
				 ModelPackage.Literals.ROUTER__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the External Gateway feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addExternalGatewayPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Router_externalGateway_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Router_externalGateway_feature", "_UI_Router_type"),
				 ModelPackage.Literals.ROUTER__EXTERNAL_GATEWAY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
