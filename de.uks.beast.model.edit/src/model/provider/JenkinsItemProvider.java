...
/**
 * This is the item provider adapter for a {@link model.Jenkins} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JenkinsItemProvider 
		...
		IItemPropertySource
{
	 ...
	 * @generated
	 */
	public JenkinsItemProvider(AdapterFactory adapterFactory)
	{
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Jenkins"));
	}
	...
	{
		String label = ((Jenkins)object).getServiceName();
		return label == null || label.length() == 0 ?
			getString("_UI_Jenkins_type") :
			getString("_UI_Jenkins_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(Jenkins.class))
		{
			case ModelPackage.JENKINS__TITLE:
